...
function CursosCardconDataProfesor({info}) {
        ...
        display = info.map((x) => {
            ...
            return (
              ...
              <Contenido>
                  ...
                  <div>
                  <Link to="tareas" state={idCurso}>
                    <Button startIcon={<AssignmentIcon/>}>Gestión de Tareas</Button>
                  </Link>
                  </div>
                  </Columna1>
              </Contenido>        
...
export default CursosCardconDataProfesor
