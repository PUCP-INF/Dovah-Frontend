      ...
      <Card>
        ...
        <div>
          <p className="text-1xl font-semibold inline border-b-4 text-blue-pucp flex-auto">
           Fecha límite para enviar una propuesta:   {info.fechaFin}
          </p>
          <p className="ml-auto font-signature text-gray-700 dark:text-gray-400">
            Recuerda que solo tienes hasta la fecha límite para poder mandar una propuesta de tema de tesis
          </p>
        </div>
      </Card>
    );
...
export default CardPeriodoActivo;
