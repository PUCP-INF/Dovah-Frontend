...
import CursosCardconDataAsesor from "../general/componentes/CursosCardconDataAsesor";
import axios from "axios";
function GestionCursosAsesor() {
  ...
  return (
    <Container>
        ...
        <CursosCardconDataAsesor info={cursos}/>
    </Container>
    
  )
}

export default GestionCursosAsesor
